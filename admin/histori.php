...
// Query histori pengaduan
$query_histori = "SELECT p.*, u.nama_lengkap, u.nis, k.nama_kategori 
                  FROM pengaduan p
...
<head>
    ...
    <title>Histori Pengaduan - Admin</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 px-4 py-3">
                <h2 class="mb-4">Histori Pengaduan</h2>
                
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0"><i class="bi bi-clock-history"></i> Semua Histori Pengaduan</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center text-muted">Belum ada histori</td>
                                    </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
